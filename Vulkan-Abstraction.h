...
// Buffer usage base types:
#define VKA_BUFFER_USAGE_SRC		VK_BUFFER_USAGE_TRANSFER_SRC_BIT
#define VKA_BUFFER_USAGE_DST		VK_BUFFER_USAGE_TRANSFER_DST_BIT
#define VKA_BUFFER_USAGE_INDEX		VK_BUFFER_USAGE_INDEX_BUFFER_BIT
#define VKA_BUFFER_USAGE_VERTEX		VK_BUFFER_USAGE_VERTEX_BUFFER_BIT
#define VKA_BUFFER_USAGE_UNIFORM	VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT
#define VKA_BUFFER_USAGE_STORAGE	VK_BUFFER_USAGE_STORAGE_BUFFER_BIT
#define VKA_BUFFER_USAGE_INDIRECT	VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT

// Buffer usage convenience types:
#define VKA_BUFFER_USAGE_SRC_DST		VKA_BUFFER_USAGE_SRC | VKA_BUFFER_USAGE_DST
#define VKA_BUFFER_USAGE_INDEX_DST		VKA_BUFFER_USAGE_INDEX | VKA_BUFFER_USAGE_DST
#define VKA_BUFFER_USAGE_VERTEX_DST		VKA_BUFFER_USAGE_VERTEX | VKA_BUFFER_USAGE_DST
#define VKA_BUFFER_USAGE_UNIFORM_DST		VKA_BUFFER_USAGE_UNIFORM | VKA_BUFFER_USAGE_DST
#define VKA_BUFFER_USAGE_STORAGE_SRC		VKA_BUFFER_USAGE_STORAGE | VKA_BUFFER_USAGE_SRC
#define VKA_BUFFER_USAGE_STORAGE_DST		VKA_BUFFER_USAGE_STORAGE | VKA_BUFFER_USAGE_DST
#define VKA_BUFFER_USAGE_STORAGE_SRC_DST	VKA_BUFFER_USAGE_STORAGE | VKA_BUFFER_USAGE_SRC_DST

// Image usage base types:
#define VKA_IMAGE_USAGE_SRC		VK_IMAGE_USAGE_TRANSFER_SRC_BIT
#define VKA_IMAGE_USAGE_DST		VK_IMAGE_USAGE_TRANSFER_DST_BIT
#define VKA_IMAGE_USAGE_COLOUR		VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT
#define VKA_IMAGE_USAGE_DEPTH		VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT
#define VKA_IMAGE_USAGE_SAMPLED		VK_IMAGE_USAGE_SAMPLED_BIT
#define VKA_IMAGE_USAGE_STORAGE		VK_IMAGE_USAGE_STORAGE_BIT

// Image usage convenience types:
#define VKA_IMAGE_USAGE_SRC_DST			VKA_IMAGE_USAGE_SRC | VKA_IMAGE_USAGE_DST
#define VKA_IMAGE_USAGE_SAMPLED_DST		VKA_IMAGE_USAGE_SAMPLED | VKA_IMAGE_USAGE_DST
#define VKA_IMAGE_USAGE_STORAGE_DST		VKA_IMAGE_USAGE_STORAGE | VKA_IMAGE_USAGE_DST
#define VKA_IMAGE_USAGE_STORAGE_SRC_DST		VKA_IMAGE_USAGE_STORAGE | VKA_IMAGE_USAGE_SRC_DST
